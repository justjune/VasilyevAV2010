// Вычисление положения тела, брошенного под углом к горизонту (метод Эйлера)
#include <iostream>
#include <cmath>
using namespace std;
int main(){
...
cout<<"y = "<<y<<" : ";
double t_end = 2 * V * sin(alpha) / g;
cout<<((t<t_end)?v*t-g*t*t/2:0)<<endl;
cout<<"x = "<<x<<" : ";
cout<<((t<t_end)?u*t:V*V*sin(2*alpha)/g)<<endl;
return 0;
}